...
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="rs_linkshare_article">
...
<input type="hidden" name="editval[rstype]" value="article">
    ...
    <table cellspacing="0" cellpadding="0" width="98%" border="0">
      <tr>
        <td valign="top">
            <table>
                <tr>
                    <td><b>[{$edit->oxarticles__oxartnum->value}] - [{$edit->oxarticles__oxtitle->value}]</b></td>
                </tr>
            </table>
            <br>
            <table>
